...
fun Beer.print() { println("맥주이름 : $name , 맥주타입 : $beerType , 맥주가격 : $cost") } ////////////////Todo////////////////
fun Beer.change_price(price: Int) { cost = price } ////////////////Todo////////////////
fun Wine.euro_to_won(operation: (Int, Int) -> Int) { println("유료 : $cost , 원화 : ${cost * 1350}") } ////////////////Todo////////////////
fun main() {
